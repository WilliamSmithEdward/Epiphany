...
> ADR numbers 0004 to 0007 are reserved for decisions due in later phases: 0004 embedded TypeScript engine, 0005 automatic feeder inference, 0006 cell storage and memory layout, 0007 rule evaluation. See `docs/ROADMAP.md` section 5.
