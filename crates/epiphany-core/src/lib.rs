...
pub use query::{
    ...
    CellTrace, Cellset, ExplainDepth, Flow, FlowTest, Model, NoSetEvaluator, QueryError, RuleSet,
    RuleTest, SetEvaluator, StoredCells, Subset, SubsetKind, TestCell, TraceKind, View, Visibility,
};
